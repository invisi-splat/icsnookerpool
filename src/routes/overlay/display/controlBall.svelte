...
<div class="ball rounded-full border-4 w-8 h-8 flex justify-center items-center text-xl font-slab font-bold {textColorMapping[value]} {borderColorMapping[value]}">
    {count}
</div>