<script lang="ts">
    ...
    const symbolMapping = ["?", "R", "Y", "G", "B", "B", "P", "B"]
</script>

<div class="ball rounded-full border-4 w-8 h-8 flex justify-center items-center text-lg font-slab {textColorMapping[value]} {borderColorMapping[value]}">
    {symbolMapping[value]}
</div>